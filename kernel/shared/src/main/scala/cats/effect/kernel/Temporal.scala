...
object Temporal {
  ...
  implicit def temporalBracketForOptionT[F[_], E](
      implicit T: TemporalBracket[F, E]
  ): Temporal[OptionT[F, *], E] =
    new OptionTTemporalBracket[F, E] {
      override def F: TemporalBracket[F, E] = T
    }
  ...
  trait OptionTTemporalBracket[F[_], E]
      extends Temporal[OptionT[F, *], E]
      with Concurrent.OptionTConcurrentBracket[F, E]
      with Clock.OptionTClock[F] {
    implicit override def F: TemporalBracket[F, E]
